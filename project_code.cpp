...
void undo(int  arr[9][9]/* StackArr s1, StackArr s2*/);
...
{
	cout << "you have " << steps << "chances" << endl;
	cout << " enter [ u ] to undo " << endl;
...
void undo( int& steps ,int  arr[9][9] /*, StackArr& s1 , StackArr& s2*/)
{
	...
	while (true)
	{
		cout << " If You Want To Undo press [ u ] if not Press [ c ]" <<endl;
		cout << "last operation  raw " << s1.Top() << " ..........  column " << s2.Top()<< endl;
		cin >> undo;
		if (undo == 'u' || undo == 'U')
		{
